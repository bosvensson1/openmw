...
namespace NifOsg
{
    ...
    public:
        ...
        /// @warning Corrupts the passed in NIFFile because we use move operations.
        static osg::ref_ptr<osg::Node> load(Nif::MutableNIFFilePtr file, Resource::ImageManager* imageManager);
